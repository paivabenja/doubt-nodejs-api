...
app.use(express_1.default.static('media')); // middleware to use static services (media)
...
const connectToDB = () => __awaiter(void 0, void 0, void 0, function* () {
    const DB = yield mongoose_1.default.connect('mongodb://paiva:contrasenia@localhost:27017/ropa?authSource=admin');
